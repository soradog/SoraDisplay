...
public class ForecastRecord {
    ...
    public static void onResponse(JSONObject response) {
        try {
            ForecastRecord.Instance = new ForecastRecord(response);
    ...
    public static ForecastRecord Instance;
    ...
    public void updateTodayViews(FragmentTodayWeatherBinding binding) {
        ...
        binding.temperature.setText(printF("%d°c", current.tempC.intValue()));
        binding.temperature.setTextColor(getTemperatureColor(current.tempC));
        binding.condition.setText(printF("%s", current.condition.text));
        ...
        new DownloadImageTask(binding.currentIcon).execute(current.condition.icon);

        binding.label1.setText("Feels:");
        binding.value1.setText(printF("%d°c", current.feelslikeC.intValue()));
        binding.value1.setTextColor(getTemperatureColor(current.feelslikeC));
        binding.label2.setText("Humidity:");
        binding.value2.setText(printF("%d%%", current.humidity.intValue()));
        binding.value2.setTextColor(getHumidityColor(current.humidity));
        binding.label3.setText("Rain:");
        binding.value3.setText(printF("%dmm", current.precipMm.intValue()));
        binding.label4.setText("Wind (km/h):");
        binding.value4.setText(printF("%d~%d", current.windKph.intValue(), current.gustKph.intValue()));

        if (forecast.forecastday.length > 0) {
            Forecastday day = forecast.forecastday[0];

            if (day.hour.length == 24) {
                binding.forecastdate.setText(day.hour[0].time.substring(5,10));
                binding.forecastlabel1.setText("°c");
                binding.forecastlabel2.setText("Rain");
                updateHourly(binding.forecasttime1, binding.forecasticon1, binding.forecastvalue1a, binding.forecastvalue1b, day.hour[3]);
                updateHourly(binding.forecasttime2, binding.forecasticon2, binding.forecastvalue2a, binding.forecastvalue2b, day.hour[7]);
                updateHourly(binding.forecasttime3, binding.forecasticon3, binding.forecastvalue3a, binding.forecastvalue3b, day.hour[11]);
                updateHourly(binding.forecasttime4, binding.forecasticon4, binding.forecastvalue4a, binding.forecastvalue4b, day.hour[15]);
                updateHourly(binding.forecasttime5, binding.forecasticon5, binding.forecastvalue5a, binding.forecastvalue5b, day.hour[19]);
                updateHourly(binding.forecasttime6, binding.forecasticon6, binding.forecastvalue6a, binding.forecastvalue6b, day.hour[23]);
            }
        }
    }
    ...
    public void updateFutureViews(FragmentWeatherForecastBinding binding) {
        ...
        if (forecast.forecastday.length > 0) {
            binding.forecastlabel1.setText("Max");
            binding.forecastlabel2.setText("Min");
            binding.forecastlabel3.setText("Rain");
            binding.forecastlabel4.setText("Humidity");
            binding.forecastlabel5.setText("Wind");
            updateDaily(binding.forecasttime1, binding.forecasticon1, binding.forecastvalue1a, binding.forecastvalue1b, binding.forecastvalue1c, binding.forecastvalue1d, binding.forecastvalue1e, forecast.forecastday[0]);
            updateDaily(binding.forecasttime2, binding.forecasticon2, binding.forecastvalue2a, binding.forecastvalue2b, binding.forecastvalue2c, binding.forecastvalue2d, binding.forecastvalue2e, forecast.forecastday[1]);
            updateDaily(binding.forecasttime3, binding.forecasticon3, binding.forecastvalue3a, binding.forecastvalue3b, binding.forecastvalue3c, binding.forecastvalue3d, binding.forecastvalue3e, forecast.forecastday[2]);
            updateDaily(binding.forecasttime4, binding.forecasticon4, binding.forecastvalue4a, binding.forecastvalue4b, binding.forecastvalue4c, binding.forecastvalue4d, binding.forecastvalue4e, forecast.forecastday[3]);
            updateDaily(binding.forecasttime5, binding.forecasticon5, binding.forecastvalue5a, binding.forecastvalue5b, binding.forecastvalue5c, binding.forecastvalue5d, binding.forecastvalue5e, forecast.forecastday[4]);
            updateDaily(binding.forecasttime6, binding.forecasticon6, binding.forecastvalue6a, binding.forecastvalue6b, binding.forecastvalue6c, binding.forecastvalue6d, binding.forecastvalue6e, forecast.forecastday[5]);
            updateDaily(binding.forecasttime7, binding.forecasticon7, binding.forecastvalue7a, binding.forecastvalue7b, binding.forecastvalue7c, binding.forecastvalue7d, binding.forecastvalue7e, forecast.forecastday[6]);
        }
    }

    private void updateHourly(TextView time, ImageView icon, TextView value1, TextView value2, Hour hour) {
        SimpleDateFormat printer = new SimpleDateFormat("HH:mm");
        SimpleDateFormat parser = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        try {
            time.setText(printer.format(parser.parse(hour.time)));
        } catch (ParseException e) {
        }
        new DownloadImageTask(icon).execute(hour.condition.icon);
        value1.setText(printF("%d°c", hour.tempC.intValue()));
        value1.setTextColor(getTemperatureColor(hour.tempC));
        Double rainOrSnow = hour.chanceOfSnow > 0.0 ? hour.chanceOfSnow : hour.chanceOfRain;
        value2.setText(printF("%d%%", rainOrSnow.intValue()));
        value2.setTextColor(getChanceOfRainColor(rainOrSnow));
    }

    private void updateDaily(TextView time, ImageView icon, TextView value1, TextView value2, TextView value3, TextView value4, TextView value5, Forecastday fd) {
        SimpleDateFormat printer = new SimpleDateFormat("dd\nEE");
        SimpleDateFormat parser = new SimpleDateFormat("yyyy-MM-dd");
        try {
            time.setText(printer.format(parser.parse(fd.date)));
        } catch (ParseException e) {
        }
        new DownloadImageTask(icon).execute(fd.day.condition.icon);
        value1.setText(printF("%d°c", fd.day.maxtempC.intValue()));
        value1.setTextColor(getTemperatureColor(fd.day.maxtempC));
        value2.setText(printF("%d°c", fd.day.mintempC.intValue()));
        value2.setTextColor(getTemperatureColor(fd.day.mintempC));
        Double rainOrSnow = fd.day.dailyChanceOfSnow > 0.0 ? fd.day.dailyChanceOfSnow : fd.day.dailyChanceOfRain;
        value3.setText(printF("%d%%", rainOrSnow.intValue()));
        value3.setTextColor(getChanceOfRainColor(rainOrSnow));
        value4.setText(printF("%d%%", fd.day.avghumidity.intValue()));
        value4.setTextColor(getHumidityColor(fd.day.avghumidity));
        value5.setText(printF("%d", fd.day.maxwindKph.intValue()));
    }
    ...
    static String printF(String format, Object... objects) {
