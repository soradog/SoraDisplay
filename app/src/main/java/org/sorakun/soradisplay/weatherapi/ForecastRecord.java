...
public class ForecastRecord {
    ...
    public void updateTodayViews(FragmentTodayWeatherBinding binding) {
        ...
        Util.callPicasso(current.condition.icon, binding.currentIcon);
    ...
    private void updateDaily(TextView time, ImageView icon, TextView value1, TextView value2, TextView value3, TextView value4, TextView value5, Forecastday fd) {
        ...
        value1.setText(Util.printF("%d°c", fd.day.maxtempC.intValue()));
        value1.setTextColor(getTemperatureColor(fd.day.maxtempC));
        value2.setText(Util.printF("%d°c", fd.day.mintempC.intValue()));
        ...
        value3.setText(Util.printF("%d%%", rainOrSnow.intValue()));
        value3.setTextColor(getChanceOfRainColor(rainOrSnow));
        value4.setText(Util.printF("%d%%", fd.day.avghumidity.intValue()));
        value4.setTextColor(getHumidityColor(fd.day.avghumidity));
        value5.setText(Util.printF("%d", fd.day.maxwindKph.intValue()));
    }
