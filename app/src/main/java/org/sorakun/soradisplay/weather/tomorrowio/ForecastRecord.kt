    ...
    data class Timelines(
        ...
        data class Daily(
            ...
            data class Values(
                ...
                var freezingRainIntensityAvg: Int = 0, // 0
                @Json(name = "freezingRainIntensityMax")
                var freezingRainIntensityMax: Int = 0, // 0
                @Json(name = "freezingRainIntensityMin")
                var freezingRainIntensityMin: Int = 0, // 0
                ...
                var iceAccumulationAvg: Int = 0, // 0
                @Json(name = "iceAccumulationLweAvg")
                var iceAccumulationLweAvg: Int = 0, // 0
                @Json(name = "iceAccumulationLweMax")
                var iceAccumulationLweMax: Int = 0, // 0
                @Json(name = "iceAccumulationLweMin")
                var iceAccumulationLweMin: Int = 0, // 0
                @Json(name = "iceAccumulationLweSum")
                var iceAccumulationLweSum: Int = 0, // 0
                @Json(name = "iceAccumulationMax")
                var iceAccumulationMax: Int = 0, // 0
                @Json(name = "iceAccumulationMin")
                var iceAccumulationMin: Int = 0, // 0
                @Json(name = "iceAccumulationSum")
                var iceAccumulationSum: Int = 0, // 0
                ...
                var precipitationProbabilityMax: Int = 0, // 70
                @Json(name = "precipitationProbabilityMin")
                var precipitationProbabilityMin: Int = 0, // 0
                ...
                var sleetAccumulationAvg: Int = 0, // 0
                @Json(name = "sleetAccumulationLweAvg")
                var sleetAccumulationLweAvg: Int = 0, // 0
                @Json(name = "sleetAccumulationLweMax")
                var sleetAccumulationLweMax: Int = 0, // 0
                @Json(name = "sleetAccumulationLweMin")
                var sleetAccumulationLweMin: Int = 0, // 0
                @Json(name = "sleetAccumulationLweSum")
                var sleetAccumulationLweSum: Int = 0, // 0
                @Json(name = "sleetAccumulationMax")
                var sleetAccumulationMax: Int = 0, // 0
                @Json(name = "sleetAccumulationMin")
                var sleetAccumulationMin: Int = 0, // 0
                @Json(name = "sleetIntensityAvg")
                var sleetIntensityAvg: Int = 0, // 0
                @Json(name = "sleetIntensityMax")
                var sleetIntensityMax: Int = 0, // 0
                @Json(name = "sleetIntensityMin")
                var sleetIntensityMin: Int = 0, // 0
                @Json(name = "snowAccumulationAvg")
                var snowAccumulationAvg: Int = 0, // 0
                @Json(name = "snowAccumulationLweAvg")
                var snowAccumulationLweAvg: Int = 0, // 0
                @Json(name = "snowAccumulationLweMax")
                var snowAccumulationLweMax: Int = 0, // 0
                @Json(name = "snowAccumulationLweMin")
                var snowAccumulationLweMin: Int = 0, // 0
                @Json(name = "snowAccumulationLweSum")
                var snowAccumulationLweSum: Int = 0, // 0
                @Json(name = "snowAccumulationMax")
                var snowAccumulationMax: Int = 0, // 0
                @Json(name = "snowAccumulationMin")
                var snowAccumulationMin: Int = 0, // 0
                @Json(name = "snowAccumulationSum")
                var snowAccumulationSum: Int = 0, // 0
                @Json(name = "snowIntensityAvg")
                var snowIntensityAvg: Int = 0, // 0
                @Json(name = "snowIntensityMax")
                var snowIntensityMax: Int = 0, // 0
                @Json(name = "snowIntensityMin")
                var snowIntensityMin: Int = 0, // 0
                ...
                var uvHealthConcernAvg: Int = 0, // 0
                @Json(name = "uvHealthConcernMax")
                var uvHealthConcernMax: Int = 0, // 1
                @Json(name = "uvHealthConcernMin")
                var uvHealthConcernMin: Int = 0, // 0
                @Json(name = "uvIndexAvg")
                var uvIndexAvg: Int = 0, // 1
                @Json(name = "uvIndexMax")
                var uvIndexMax: Int = 0, // 4
                @Json(name = "uvIndexMin")
                var uvIndexMin: Int = 0, // 0
        ...
        data class Hourly(
            ...
            data class Values(
                ...
                var freezingRainIntensity: Int = 0, // 0
                @Json(name = "humidity")
